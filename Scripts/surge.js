...
$done({
    title:"Surge  已运行"+startTime,      content:"--------------------------"+"Mitm:"+icon_status(mitm_status.enabled)+"  Rewrite:"+icon_status(rewrite_status.enabled)+"  Scripting:"+icon_status(scripting_status.enabled),
